...
public class Weather extends Activity implements OnClickListener {
	...
	final private String DATE_KEY[] = {"date_0", "data_1", "data_2", "data_3"};
	...
	private SharedPreferences sp;//Android平台上一个轻量级的存储类，用来保存应用的一些常用配置
	private LinearLayout weatherBg;
	private LinearLayout titleBarLayout;//标题栏，包括：定位城市，三个按钮，更新时间信息
	private LinearLayout changeCity;
	private TextView cityText;
	private ImageView share;
	private ImageView about;
	private ImageView refresh;
	private ProgressBar refreshing;//刷新进度条
	...
	public void onClick(View v) {
		...
		case R.id.share:
			...
			intent.putExtra(Intent.EXTRA_TEXT,
					"我正在使用Rainbow Weather，可以随时随地查看天气信息，是您出差、旅行的贴心助手！推荐你也试试~");
				...
				builder.setNegativeButton("取消",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								intent = new Intent();
								intent.setClass(Weather.this, Weather.class);
								Weather.this
										.startActivityForResult(intent, 100);
							}
						});
	...
	/**
	 * 传入天气预报信息到weatherForecastList 这个listView中
	 * @author 
	 *
	 */
	...
	private void exitBy2Click() {
		...
		if (isExit == false) {
			isExit = true;
			Toast.makeText(this, "再按一次退出Rainbow Weather", Toast.LENGTH_SHORT).show();
			timer = new Timer();
